  ...
  return (
    <div className="thank-you-container">
      ...
      <div className="checkmark">
        {[...Array(6)].map((_, i) => (
          <svg key={i} className={`confetti confetti-${i + 1}`} height="19" viewBox="0 0 19 19" width="19" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="footer-text">
        <p>We have received your feedback and appreciate your time.</p>
      </div>
    </div>
  );
};
